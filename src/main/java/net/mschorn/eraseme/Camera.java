...
public class Camera {
	...
	private void setViewMatrix(final float eyeX, final float eyeY, final float eyeZ) {
	...
	public void updateViewMatrix(final float eyeX, final float eyeY, final float eyeZ) {
		this.setViewMatrix(eyeX, eyeY, eyeZ);
